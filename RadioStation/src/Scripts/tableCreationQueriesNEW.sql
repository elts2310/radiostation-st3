...
CREATE TABLE ALBUM (
    ...
    ARTIST_ID BIGINT,
    PRIMARY KEY (ALBUM_ID, DISC_NUMBER) /*Δεν ξέρω κατά πόσο έχει πρακτική αξία ένα "διπλό κλειδί, αφού ένα άλμπουμ με περισσότερα του ενός CD θα φαίνεται δύο φορές στον πίνακα, καθώς επεξεργαζόμαστε τα στοιχεία του κάθε CD ξεχωριστά*/
);
